...
## Theory
The first real row is a bounded `pilot_analysis` variant, while fake IDs remain in test fixtures.
...
## Test Strategy
It checks `hanon-01-c` dimensions, production overlay linkage, support level, and synthetic overlay linkage.
